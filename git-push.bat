@echo off
echo Running Git Push Script for https://github.com/fenago/AiMazing
echo ==========================================

echo Setting remote repository to https://github.com/fenago/AiMazing...
git remote remove origin 2>nul
git remote add origin https://github.com/fenago/AiMazing.git
...
if /i "%confirm%"=="Y" (
  echo Pushing to GitHub repository: https://github.com/fenago/AiMazing
